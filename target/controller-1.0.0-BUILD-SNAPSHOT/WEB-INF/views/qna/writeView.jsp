...
<html>
	...
	<body>
			...
			<div class ="move_box">
					<button class="butt2" onclick="location.href='/qna/list.do'">LIST</button>
					<button style="margin-left: 10px;" class="butt2" onclick="location.href='/qna/writeView'">WRITE</button>
