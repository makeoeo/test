		...
		<div class="container">
			<div class = "header_board">	
				<div class="header_logo">
		  			 ...
		  			 <a style="margin-left: 10px;" href="/">QnA Board</a>
				</div>
					...
					<tr>
						...
						<c:forEach items="${list}" var = "list">
							<tr>
								...
								<td>
									<a href="/qna/readView?bno=${list.bno}&page=${scri.page}&perPageNum=${scri.perPageNum}&searchType=${scri.searchType}&keyword=${scri.keyword}"><c:out value="${list.title}" /></a>
								</td>
