	...
	<body>
		<form id="updateForm" action="/member/memberUpdate" method="post">
				...
				<dl>
					...
					<dd><input class="form-control" type="text" id="userName" name="userName" value="${member.userName}" /></dd>
				</dl>
            	<hr>
				<dl>
				...
				<dl>
					...
					<dd style="color: #000;">	
						<input type="text" id="useradd1" placeholder="Zipcode" name="useradd1"value="${update.useradd1}">
						<button  class="butt zipbtn" type="button" onclick="sample6_execDaumPostcode()" style="width: 160px;">Finding a zip code</button><br>
						<input type="text" id="useradd2" placeholder="Add" name="useradd2" value="${update.useradd2}"><br>
						<input type="text" id="useradd3" placeholder="Detail Add" name="useradd3" value="${update.useradd3}">
						<input type="text" id="useradd4" placeholder="Reference Add" name="useradd4" value="${update.useradd4}">
					</dd>
				</dl>
				<hr>
				<br>
				...
				<div class="move_box">
					...
					<button class="butt1" type="button">Cancel</button>
				</div>
			</form>
	</body>
