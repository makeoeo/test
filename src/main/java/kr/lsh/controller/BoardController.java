...
import kr.lsh.service.BoardService;
import kr.lsh.service.ReplyService;
...
public class BoardController {
	...
	public void fileDown(@RequestParam Map<String, Object> map, HttpServletResponse response) throws Exception{
		...
		byte fileByte[] = org.apache.commons.io.FileUtils.readFileToByteArray(new File("C:\\spring\\workspace\\.metadata\\.plugins\\org.eclipse.wst.server.core\\tmp1\\wtpwebapps\\pro3\\resources\\mp3\\"+storedFileName));
