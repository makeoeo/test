...
import kr.lsh.service.MemberService;
...
public class MemberController {
	...
	public String registerUpdateView(MemberVO vo, HttpSession session, Model model) throws Exception{
		
		vo = (MemberVO)session.getAttribute("member");
		
		MemberVO selectVo = service.updateView(vo);	
		
		model.addAttribute("update", selectVo);
