	...
	<body>
            ...
            <div class="header_logo">
             ...
             <c:if test="${member.userId == null}">
               <div class ="move_box">
                  <button class="butt2" onclick="location.href='/qna/list'">LIST</button>
			...
			<section id="container">
				<form name="writeForm" method="post" action="/qna/write" enctype="multipart/form-data">
					<table>
						<tbody>
							<c:if test="${member.userId != null}">
								<tr>
								...
								<tr>
									<td>
										...
										<textarea id="content" name="content" class="chk" title="Enter the content." style="resize:none;"></textarea>
									</td>
								</tr>
								<tr>
									<td>
